...
[box#.horizmix]{style="color: orange;"} -- horizontal mixing scalar that can be used to correct for hyperdifusion (if insufficient correction was done during the file conversion stage, see Chapter 5.4). It is also used as a box-specific scalar if [fill_zero_exchange]{style="color: orange;"} or [horiz_diffusion]{style="color: orange;"} flags are turned on (set to 1) in the *physics.prm* file (see Chapter 5 for further details).
