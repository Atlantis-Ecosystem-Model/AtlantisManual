...
The final flows of water are given in the output.nc file listed in [hdsource]{style="color: orange;"}, [hdsink]{style="color: orange;"}, [eflux]{style="color: orange;"} and [vflux]{style="color: orange;"} (see description of the ouput file parameters in chapter 5.6). If some of the optional physics routines are used, then these final exhcanges may be different from the hydrodynamic forcing inputs.
:::
