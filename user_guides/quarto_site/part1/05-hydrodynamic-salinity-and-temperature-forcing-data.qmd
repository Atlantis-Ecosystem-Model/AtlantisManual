...
These three steps constitute the main conversion and are conducted using the [*Hydro*](https://atlantis-ecosystem-model.github.io/atlantis-wiki/matlab-hydro.html) Matlab script (follow the link for further instructions on installation and use of the *Hydro* script and also check [*Hydro* FAQ](https://atlantis-ecosystem-model.github.io/atlantis-wiki/hydro-faq.html) for more information). *Hydro* produces two NC files which are then used by [*Hydroconstruct*](https://atlantis-ecosystem-model.github.io/atlantis-wiki/hydroconstruct.html) to produce the final Atlantis forcing files. *Hydroconstruct* makes sure the order of water columns is in the right direction, transforms the water flux data into per layer per box fluxes and also corrects for hyperdifussion (using either area based scaling or area and box shape based scaling). The *Hydroconstruct* [running](https://atlantis-ecosystem-model.github.io/atlantis-wiki/running-hydroconstruct.html) page and [parameter](https://atlantis-ecosystem-model.github.io/atlantis-wiki/attachments/43156182.prm) file provides further information on the script and how to run it.
...
*Note: Hydroconstruct is generally unsupported at this time. More generalized workflows are underway*
...
The final flows of water are given in the output.nc file listed in [hdsource]{style="color: orange;"}, [hdsink]{style="color: orange;"}, [eflux]{style="color: orange;"} and [vflux]{style="color: orange;"} (see description of the ouput file parameters @sec-output-physical-tracers). If some of the optional physics routines are used, then these final exhcanges may be different from the hydrodynamic forcing inputs.
:::
...
- *forcing.prm file*: set [use_pollutantfiles]{style="color: orange;"} to 1 and then
