...
| **Hydrodynamic model used to supply flows** | OFAM-Bluelink¹ | OFAM-Bluelink | 3D hydro model² | Empirically defined | HYCOM³ | ROMS⁴ | ROMS⁵ |
...
- ⁶ Implicit handling of climate change means that extra mortality terms (related to acidification) or forced changes (e.g. for temperature) are used rather than flows from downscaled global circulation models.
