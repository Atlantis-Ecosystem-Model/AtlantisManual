...
There is an option to allow for stimulation of bacterial growth by bioirrigation and bioturbation. This option is turned setting [flagbactstim]{style="color: orange;"}=1 and will enhance growth depending on the biomass of infaunal organisms and porosity of the sediment (see @sec-focing-files).
