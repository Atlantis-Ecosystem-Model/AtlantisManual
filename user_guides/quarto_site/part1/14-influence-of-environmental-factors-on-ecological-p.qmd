...
| Modifying thermal tolerance of a species | [flagpHsensitive_XXX]{style="color: orange;"}=1<br><br>[flagcontract_tol_XXX]{style="color: orange;"}=1 | The thermal tolerance decreases according to [contract_tol_XXX]{style="color: orange;"} parameter, which defines the number of degrees to contract the temperature tolerances by as pH drops |
