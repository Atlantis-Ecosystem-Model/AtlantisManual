...
![Some existing applications of Atlantis modelling framework and specific model domains (@tbl-atlantis-applications) for details on numbered models).](media/image2.png){#fig-atlantis-applications width=8in height=6in}
...
## **How does Atlantis compare to other marine ecosystem models?**
