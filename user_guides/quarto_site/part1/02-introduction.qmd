...
![Some existing applications of Atlantis modelling framework and specific model domains (see @tbl-atlantis-applications (old Table 1) for details on numbered models).](media/image2.png){#fig-atlantis-applications width=8in height=6in}
