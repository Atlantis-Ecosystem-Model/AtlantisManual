...
| pseudo_assess<br>useRBCTiers | Flags determining which fisheries stock assessments are applied to calculated dynamic TACs (see Note! in chapter 16.1) |
...
| co_sp_XXX vector<br>co_sp_catch_XXX | Vectors giving the ID numbers and ratios of companion species (species that are caught together) caught with each biomass unit of species XXX. Used when YYY_flagmanage=5. See chapter 16.2.4 for further details and related parameters. |
